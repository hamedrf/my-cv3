...
const About = () => {
  return (
    <section className="row">
      ...
      <div className="col-xl-7 p-5 col-lg-6 col-12 d-flex justify-content-center">
        <div className="w-50 px-3 d-flex flex-column justify-content-evenly align-items-center">
          <SkillProgress
            icon={
              <>
                <svg
          ...
          <SkillProgress
            icon={
              <>
                ...
                />
                <div className="icon-skill-progress fw-bolder fs-3 gsap-color">
                  GSAP
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
